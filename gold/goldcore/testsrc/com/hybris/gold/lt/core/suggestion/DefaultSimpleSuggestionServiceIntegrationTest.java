 ...
 */
package com.hybris.gold.lt.core.suggestion;
...
import com.hybris.gold.lt.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/goldcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
