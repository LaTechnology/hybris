 ...
 */
package com.hybris.gold.lt.core.constants;

/**
 * Global class for all GoldCore constants. You can add global constants for your extension into this class.
 */
public final class GoldCoreConstants extends GeneratedGoldCoreConstants
{
	public static final String EXTENSIONNAME = "goldcore";


	private GoldCoreConstants()
	{
		//empty
	}
