 ...
 */
package com.hybris.gold.lt.cockpits.setup;
...
import com.hybris.gold.lt.cockpits.constants.GoldCockpitsConstants;
 ...
 */
@SystemSetup(extension = GoldCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(GoldCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(GoldCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						GoldCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/goldcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
