 ...
 */
package com.hybris.gold.lt.test.setup;
...
import com.hybris.gold.lt.test.constants.GoldTestConstants;
import com.hybris.gold.lt.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GoldTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/goldtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/goldtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/goldtest/import/cstickets.impex");
			...
			importImpexFile(context, "/goldtest/import/csquotes.impex");
		}
	}
}
