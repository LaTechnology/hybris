...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/goldstorefront/electronics/en",
						"https://electronics.local:9002/goldstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/goldstorefront/electronics/en",
						"https://electronics.local:9002/goldstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/goldstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/goldstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/goldstorefront/electronics/en",
						"https://electronics.local:9002/goldstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/goldstorefront",
						"https://electronics.local:9002/goldstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/goldstorefront",
						"https://electronics.local:9002/goldstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/goldstorefront/electronics/en",
						"https://electronics.local:9002/goldstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
