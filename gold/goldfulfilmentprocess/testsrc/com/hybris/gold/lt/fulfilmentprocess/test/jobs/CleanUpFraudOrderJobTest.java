 ...
 */
package com.hybris.gold.lt.fulfilmentprocess.test.jobs;
...
import com.hybris.gold.lt.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = GoldFulfilmentProcessConstants.ORDER_PROCESS_NAME;
