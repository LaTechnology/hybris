 ...
 */
package com.hybris.gold.lt.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(GoldFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GoldFulfilmentProcessConstants.PARENT_PROCESS);
