 ...
 * 
 */
public interface CMSComponentAdminFacade
{
	ComponentAdminMenuGroupData getLiveEditAdminMenu(ComponentActionMenuRequestData request) throws PreviewTicketInvalidException;
}
