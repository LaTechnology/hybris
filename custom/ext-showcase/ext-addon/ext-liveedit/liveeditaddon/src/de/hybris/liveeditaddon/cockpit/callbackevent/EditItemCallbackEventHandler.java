 ...
 * 
 */
public class EditItemCallbackEventHandler extends AbstractLiveEditCallbackEventHandler<LiveEditView>
{
	...
	{
		final PK pk = PK.parse((String) attributeMap.get("item_pk"));
