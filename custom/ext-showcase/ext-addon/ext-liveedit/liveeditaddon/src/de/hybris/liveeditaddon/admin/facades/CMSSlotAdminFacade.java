 ...
 * 
 */
public interface CMSSlotAdminFacade
{
	ComponentAdminMenuGroupData getLiveEditSlotAdminMenu(SlotActionMenuRequestData request) throws PreviewTicketInvalidException;
}
