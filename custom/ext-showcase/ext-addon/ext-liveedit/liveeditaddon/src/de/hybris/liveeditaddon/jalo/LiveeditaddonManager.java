...
/**
 * This is the extension manager of the Liveeditaddon extension.
 */
public class LiveeditaddonManager extends GeneratedLiveeditaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LiveeditaddonManager.class.getName());
	 ...
	 */
	public static LiveeditaddonManager getInstance()
	{
		return (LiveeditaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LiveeditaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LiveeditaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LiveeditaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LiveeditaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LiveeditaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
