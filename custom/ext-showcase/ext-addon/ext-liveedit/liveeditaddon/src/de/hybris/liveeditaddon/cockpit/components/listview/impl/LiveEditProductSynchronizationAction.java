 ...
 * 
 */
public class LiveEditProductSynchronizationAction extends AbstractSynchronizationAction
{
	private static final Logger LOG = Logger.getLogger(LiveEditProductSynchronizationAction.class);
				...
				public void onEvent(final Event event) throws Exception //NOPMD: ZK Specific
				{
					...
					finally
					{
						...
						UISessionUtils.getCurrentSession().sendGlobalEvent(
								new ItemChangedEvent(LiveEditProductSynchronizationAction.this, context.getItem(), null));
					}
				}
			};
