 ...
 *  
 */
package de.hybris.mediaconversionimageresizeplugin.jalo;
...
import de.hybris.mediaconversionimageresizeplugin.constants.MediaconversionimageresizepluginConstants;



/**
 * This is the extension manager of the Mediaconversionimageresizeplugin extension.
 */
public class MediaconversionimageresizepluginManager extends GeneratedMediaconversionimageresizepluginManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MediaconversionimageresizepluginManager.class.getName());
	 ...
	 */
	public static MediaconversionimageresizepluginManager getInstance()
	{
		return (MediaconversionimageresizepluginManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MediaconversionimageresizepluginConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MediaconversionimageresizepluginManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MediaconversionimageresizepluginManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MediaconversionimageresizepluginManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MediaconversionimageresizepluginManager called, current tenant: " + getTenant().getTenantID());
		}
	}
