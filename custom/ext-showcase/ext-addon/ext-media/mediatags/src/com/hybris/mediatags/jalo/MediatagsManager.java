 ...
 *  
 */
package com.hybris.mediatags.jalo;
...
import com.hybris.mediatags.constants.MediatagsConstants;



/**
 * This is the extension manager of the Mediatags extension.
 */
public class MediatagsManager extends GeneratedMediatagsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MediatagsManager.class.getName());
	 ...
	 */
	public static MediatagsManager getInstance()
	{
		return (MediatagsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MediatagsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MediatagsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MediatagsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MediatagsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MediatagsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
