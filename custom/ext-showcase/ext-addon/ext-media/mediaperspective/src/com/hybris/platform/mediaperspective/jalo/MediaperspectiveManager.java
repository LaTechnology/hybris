 ...
 *  
 */
package com.hybris.platform.mediaperspective.jalo;
...
import com.hybris.platform.mediaperspective.constants.MediaperspectiveConstants;



/**
 * This is the extension manager of the Mediaperspective extension.
 */
public class MediaperspectiveManager extends GeneratedMediaperspectiveManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MediaperspectiveManager.class.getName());
	 ...
	 */
	public static MediaperspectiveManager getInstance()
	{
		return (MediaperspectiveManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MediaperspectiveConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MediaperspectiveManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MediaperspectiveManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MediaperspectiveManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MediaperspectiveManager called, current tenant: " + getTenant().getTenantID());
		}
	}
