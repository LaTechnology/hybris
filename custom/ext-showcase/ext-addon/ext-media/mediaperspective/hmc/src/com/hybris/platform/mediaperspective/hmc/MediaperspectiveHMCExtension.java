 ...
 *  
 */
package com.hybris.platform.mediaperspective.hmc;
...
/**
 * Provides necessary meta information about the mediaperspective hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0
 */
public class MediaperspectiveHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MediaperspectiveHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.hybris.platform.mediaperspective.hmc.locales";
