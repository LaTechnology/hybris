 ...
 *
 */
package com.greenlee.test.setup;
...
import com.greenlee.test.constants.GreenleeTestConstants;
import com.greenlee.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GreenleeTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/greenleetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/greenleetest/import/reviews.impex");
			...
			importImpexFile(context, "/greenleetest/import/cstickets.impex");
		}
	}
}
