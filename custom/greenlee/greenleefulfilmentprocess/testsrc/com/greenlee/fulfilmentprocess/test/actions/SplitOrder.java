 ...
 *
 */
package com.greenlee.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(GreenleeFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GreenleeFulfilmentProcessConstants.PARENT_PROCESS);
