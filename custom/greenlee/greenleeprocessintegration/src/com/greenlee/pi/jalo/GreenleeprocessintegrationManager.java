...
import com.greenlee.pi.constants.GreenleeprocessintegrationConstants;



/**
 * This is the extension manager of the Greenleeprocessintegration extension.
 */
public class GreenleeprocessintegrationManager extends GeneratedGreenleeprocessintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GreenleeprocessintegrationManager.class.getName());
	 ...
	 */
	public static GreenleeprocessintegrationManager getInstance()
	{
		return (GreenleeprocessintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GreenleeprocessintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GreenleeprocessintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GreenleeprocessintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GreenleeprocessintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GreenleeprocessintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
