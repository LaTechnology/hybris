 ...
 *
 */
package com.greenlee.facades.suggestion.impl;
...
import com.greenlee.core.suggestion.SimpleSuggestionService;
import com.greenlee.facades.suggestion.SimpleSuggestionFacade;
        ...
        if (getCartService().hasSessionCart())
        {
            ...
            if (!products.isEmpty())
            {
                return Converters.convertAll(
                        getSimpleSuggestionService().getReferencesForProducts(new LinkedList<ProductModel>(products),
                                referenceTypes, getUserService().getCurrentUser(), excludePurchased, limit),
                        getProductConverter());
            }
        }
