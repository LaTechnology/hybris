...
public class OrderPartiallyModifiedEmailContext extends AbstractEmailContext<OrderModificationProcessModel>
{
    ...
    protected void fillModifiedEntries(final OrderModificationProcessModel orderProcessModel)
    {
                ...
                .getOrderEntriesModificationEntries())
        {
            ...
            if (modificationEntry instanceof OrderEntryCancelRecordEntryModel)
            {
                final OrderEntryCancelRecordEntryModel cancelEntry = (OrderEntryCancelRecordEntryModel) modificationEntry;
                if (cancelEntry.getCancelledQuantity() != null)
                {
                    orderEntryData.setQuantity(Long.valueOf(cancelEntry.getCancelledQuantity().longValue()));
                }
            }
