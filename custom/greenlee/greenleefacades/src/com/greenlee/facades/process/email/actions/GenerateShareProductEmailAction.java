 ...
 *
 */
package com.greenlee.facades.process.email.actions;
...
import com.greenlee.facades.process.email.EmailGenerationService;


/**
 *
 */
public class GenerateShareProductEmailAction extends AbstractSimpleDecisionAction
{
    private static final Logger              LOG = Logger.getLogger(GenerateShareProductEmailAction.class);
        ...
        if (contentCatalogVersion != null)
        {
            ...
            if (emailPageModel != null)
            {
                final EmailMessageModel emailMessageModel = getEmailGenerationService()
                        .generate((ShareProductProcessModel) businessProcessModel, emailPageModel);
