 ...
 *
 */
package com.greenlee.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("greenleecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("greenleecockpits.product.externalTaxes"));
