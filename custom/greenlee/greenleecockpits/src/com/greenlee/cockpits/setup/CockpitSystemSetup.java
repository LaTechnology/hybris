 ...
 *
 */
package com.greenlee.cockpits.setup;
...
import com.greenlee.cockpits.constants.GreenleeCockpitsConstants;
 ...
 */
@SystemSetup(extension = GreenleeCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(GreenleeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(GreenleeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						GreenleeCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/greenleecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
