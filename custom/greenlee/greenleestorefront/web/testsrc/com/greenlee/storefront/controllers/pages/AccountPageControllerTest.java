...
public class AccountPageControllerTest
{
	...
	public void shouldGetAddressForm()
	{
		...
		final GreenleeAddressForm addressForm = new GreenleeAddressForm();
	...
	// Orders Tests
	/*
	 * @Test public void shouldGetAllOrders() throws CMSItemNotFoundException { final ShowMode showMode = ShowMode.All;
	 * setupExistingOrder();
