...
public class CheckoutController extends AbstractCheckoutController
{
			...
			throws CMSItemNotFoundException
	{
		...
		{
			final String accountNumber = greenleeUserFacade.getAccNoFromB2BUnit(getUser());
		...
		if (UserTypes.B2E.getCode().equals(b2bUnit.getUserType()))
		{
			model.addAttribute(COMPANY_NAME, b2bUnit.getName());
			model.addAttribute(USERTYPE, b2bUnit.getUserType());
		}
		//GRE-2111
