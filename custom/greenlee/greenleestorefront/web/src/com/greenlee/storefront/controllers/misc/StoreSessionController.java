...
import com.greenlee.storefront.filters.StorefrontFilter;
...
public class StoreSessionController extends AbstractController
{
	...
	public String selectCurrency(@RequestParam("code") final String isoCode, final HttpServletRequest request)
	{
		...
		{
			LOG.error("Error during currency selection" + ex);
		}
		//		userFacade.syncSessionCurrency(); // This should be removed dueo to avoid the unwanted save while switching the currency.
