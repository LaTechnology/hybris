 ...
 *
 */
package com.greenlee.storefront.controllers.misc;
...
public class MiniCartController extends AbstractController
{
	...
	@RequestMapping(value = "/cart/removeProduct", method = RequestMethod.GET)
	public String removeProduct(@RequestParam("entryNumber") final Integer entryNumber, @RequestParam("uid") final String uid,
			final Model model) throws CMSItemNotFoundException
	{
		...
		return rolloverMiniCartPopup(uid, model);
