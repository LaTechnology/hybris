...
import com.greenlee.storefront.util.CSRFTokenManager;
import com.greenlee.storefront.web.view.UiExperienceViewResolver;
...
public class UiThemeResourceBeforeViewHandler implements BeforeViewHandler
{
	...
	public boolean isCurrencyDisabled()
	{
		...
		boolean disableCurrency = false;
		if (customerData.getSessionB2BUnit() != null)
		{
			disableCurrency = ("B2B").equals(customerData.getSessionB2BUnit().getUserType())
					|| ("B2E").equals(customerData.getSessionB2BUnit().getUserType())
					|| ("B2C").equals(customerData.getSessionB2BUnit().getUserType());
		}
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		modelAndView.addObject("disableCurrency", isCurrencyDisabled());
	...
	protected List getAddOnCommonCSSPaths(final String contextPath, final String uiExperience, final List<String> addOnNames)
	{
		...
		{ RESOURCE_TYPE_CSS + ".paths", RESOURCE_TYPE_CSS + ".paths." + uiExperience };
	...
	{
		final String[] propertyNames = new String[]
		{ RESOURCE_TYPE_JAVASCRIPT + ".paths", RESOURCE_TYPE_JAVASCRIPT + ".paths." + uiExperience };
