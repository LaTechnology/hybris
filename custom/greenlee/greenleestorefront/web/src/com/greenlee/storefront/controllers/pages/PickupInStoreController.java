...
import com.greenlee.storefront.security.cookie.CustomerLocationCookieGenerator;
...
public class PickupInStoreController extends AbstractSearchPageController
{
	...
	private static final String BASKET_INFORMATION_QUANTITY_REDUCED_NUMBER_OF_ITEMS_ADDED = "basket.information.quantity.reducedNumberOfItemsAdded.";
		...
		try
		{
			...
			else if (cartModification.getQuantityAdded() < qty)
			{
				model.addAttribute("errorMsg",
						BASKET_INFORMATION_QUANTITY_REDUCED_NUMBER_OF_ITEMS_ADDED + cartModification.getStatusCode());
			}
			...
			final RedirectAttributes redirectModel) throws CommerceCartModificationException
	{
		...
		else if (!CommerceCartModificationStatus.SUCCESS.equals(cartModificationData.getStatusCode()))
		{
			...
			GlobalMessages.addFlashMessage(redirectModel, GlobalMessages.ERROR_MESSAGES_HOLDER,
					BASKET_INFORMATION_QUANTITY_REDUCED_NUMBER_OF_ITEMS_ADDED + cartModificationData.getStatusCode());
		}
