...
import com.greenlee.storefront.interceptors.beforecontroller.RequireHardLoginBeforeControllerHandler;
...
public class DefaultGUIDCookieStrategy implements GUIDCookieStrategy
{
	...
	{
		LOG.info("Setting guid cookie and session attribute: " + !request.isSecure());
		if (!request.isSecure())
		{
			LOG.error("Cannot remove secure GUIDCookie during an insecure request. I should have been called from a secure page.");
		}
