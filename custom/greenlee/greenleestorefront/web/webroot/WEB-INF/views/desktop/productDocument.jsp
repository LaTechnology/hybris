    ...
    <div class="doc-search-container search-result">
      <div class="container">
				...
				<div class="search-here">
					...
					<div class="control-group">
					  <div class="controls">
						...
						<label class="over-label"><spring:theme code="productDocument.resultsFor" text="Results For"/>""<span>${searchText}</span>"<a href="${documentLandingpage}"><i class="fa fa-close"></i></a></label>
						</c:if>
						</form>
					  </div>
					</div>
		...
		<div class="hidden-xs hidden-sm did-you-find">
			...
			<p><spring:theme code="productDocument.check" text="If not, check to make sure you entered your model number correctly,"/> </br><spring:theme code="productDocument.email" text="or email support@getairscout.com or call 1-800-198-9384"/></p>
		</div>
	  </div>
    </div>
    </div>
