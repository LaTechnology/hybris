...
<div class="container">
    ...
    <div class="category-landing">
        ...
        <div id="applications" class="half-table applications">
            <cms:pageSlot position="Section4" var="feature" element="div" class="disp-img simple-banner">
                <c:choose>
                    <c:when test="${isFirstElement}">
                        <div class="thumb">
                            <cms:component component="${feature}" element="div" class="responsive-video"/>
                        </div>
                    </c:when>
                    <c:otherwise>
                        <div class="details">
                ...
                <div class="row">
                    <cms:pageSlot position="Section5" var="feature">
                        <c:if test="${!isLastElement}">
                            <cms:component component="${feature}" element="div" class="col-xs-6 col-md-3"/>
                        </c:if>
                    </cms:pageSlot>
                </div>
            </div>
        ...
        <div id="models" class="product-list models">
            <div class="container">
                <div class="title-row">
                    ...
                    <cms:pageSlot position="Section7a" var="feature" element="div" class="model-cat">
                        <cms:component component="${feature}"/>
                    </cms:pageSlot>
                </div>
