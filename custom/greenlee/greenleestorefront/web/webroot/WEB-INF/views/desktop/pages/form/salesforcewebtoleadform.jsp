...
<!--  ----------------------------------------------------------------------  -->
<div class="pdp-popup js-demo-Model saleforceform">
    <META HTTP-EQUIV="Content-type" CONTENT="text/html; charset=UTF-8">
        ...
        <div class="demo-title">
            <div class="content">
                <p>Have a question about a product or replacement part? Are you interested in having a Professional Tool Specialist visit your work site to provide tool, safety and ergonomic demonstrations? Or possibly you would be interested in renting one of our products?</p> 
                <h5>Simply complete the form below.</h5>
            </div>
        </div>
...
<option value="ZW - Zimbabwe">ZW - Zimbabwe</option>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="Request_Type__c">Request Type</label>
                            <div class="controls isBorder">
                                <select id="Request_Type__c" name="Request_Type__c" title="Request Type" class="custom-select">
                                    <option value="">--None--</option>
                                    <option value="Request a Demo">Request a Demo</option>
                                    <option value="Request a Rental">Request a Rental</option>
