...
<div class="container">
	...
	<div class="container switch-page">
	<div class="row">
			<div class="col-md-12 cart-switch">
		...
		<div class="row">
			<cms:pageSlot position="SideContent" var="feature" class="accountPageSideContent">
				...
				<div class="account-section col-md-6 col-md-offset-1">
					<cms:pageSlot position="BodyContent" var="feature" element="div" class="accountPageBodyContent switch-body">
						<cms:component component="${feature}" />
					</cms:pageSlot>
				</div>
