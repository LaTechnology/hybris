...
<template:page pageTitle="${pageTitle}">
	...
	<div class="category-landing live-layout">
		<div class="banner">
		...
		<%-- 		<div id="accesspoints" class="accesspoints-section">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				...
				<div class="row business-content">
					<cms:pageSlot position="Section5a" var="feature">
						<cms:component component="${feature}" element="div"
							class="col-xs-6 col-sm-6 col-md-4 col-lg-4 business-item" />
					</cms:pageSlot>
				</div>
			</div>
		</div>
