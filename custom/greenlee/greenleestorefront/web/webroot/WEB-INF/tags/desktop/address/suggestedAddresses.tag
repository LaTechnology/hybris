			...
			<c:forEach var="suggestedAddress" items="${suggestedAddresses}">
				<div class="span-8 suggested_address">
					<ul>
						...
						<c:if test="${empty suggestedAddress.region.name}">
							...
							<li>
								${suggestedAddress.country.name}, ${suggestedAddress.district}
							</li>
						</c:if>
					</ul>
				</div>
				<div class="span-5 suggested_address_submit last">
					<form:form method="post" commandName="addressForm" action="${selectSuggestedAddressUrl}">
						...
						<input id="district" name="district" type="hidden" value="${suggestedAddress.district}"/>
			...
			<div class="span-8 suggested_address">
				<ul>
					...
					<c:if test="${empty inputAddress.region.name}">
						...
						<li>
							${inputAddress.country.name}, ${inputAddress.district}
						</li>
					</c:if>
				</ul>
			</div>
			<div class="span-5 suggested_address_submit last">
				<c:if test="${customerBypass}">
					<form:form method="post" commandName="addressForm" action="${selectSuggestedAddressUrl}">
						...
						<input id="district" name="district" type="hidden" value="${inputAddress.district}"/>
