    ...
    ratingstars = {
                ...
                if (!$(this).hasClass('done')) {
                    ...
                    for (var i = 1; i <= ratingData.total; i++) {
                        ...
                        if (i <= ratingData.rating) {
                            $clone.addClass('active fa-star').removeClass('fa-star-o');
                        }

                        // divides the icons for the half rating points
                        if (i - 0.5 == ratingData.rating) {
                            $clone.addClass('active fa-star fh').removeClass('fa-star-o');
        ...
        bindRatingStarsSet: function() {
            ...
            $e.on('mouseenter', '.js-rationIconSet', function(e) {
                e.preventDefault();
                $(this).parent().children().removeClass('active fa-star').addClass('fa-star-o');
            ...
            $(document).on('mouseleave', '.js-ratingCalcSet', function(e) {
                ...
                $(this).find('.js-rationIconSet').removeClass('active fa-star').addClass('fa-star-o');
