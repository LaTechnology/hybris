    ...
    $.Carousel.prototype = {
        ...
        setCarouselSize: function(args) {
            ...
            if (this.opts.vertical === false) {
                this.el.theList.css({
                    left: this.el.scrollPos
                });
            } else {
                this.el.theList.css({
                    top: this.el.scrollPos
                });
            }
        },
        //////////////////////////////////////////////
        ...
        rotation: function() {
            ...
            var container = this;
            this.el.rotateTimer = setTimeout(function() {
                container.rotation();
            }, (this.opts.rotatingSpeed + this.opts.rotatingPause));
        ...
        bindControls: function() {
            ...
            $(this.opts.scrollNext).bind(this.opts.controlEvent + '.' + this.namespace, function() {
                ...
                if (container.opts.rotating === true) {
                    ...
                    container.el.rotateTimer = setTimeout(function() {
                        container.rotation();
                    }, container.opts.rotatingPause);
                }
