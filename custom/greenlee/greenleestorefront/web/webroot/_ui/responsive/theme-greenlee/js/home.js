...
/***/ function(module, exports, __webpack_require__) {
	...
	var Imager = __webpack_require__(3);	
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* MODIFIED */
	...
	;(function (window, document) {
		...
		if (typeof module === 'object' && typeof module.exports === 'object') {
			...
			!(__WEBPACK_AMD_DEFINE_RESULT__ = function () { return Imager; }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports) {
	...
	var owl = $('.orange-carousel');
	var powl = $('.pdp-carousel');
...
/***/ function(module, exports) {
	...
	$('.account-switch').on('click','li',function(){
		var _that = $(this),code;
		if(_that.find('.fa').length == 0){
			$('.account-switch li .fa').remove();
			_that.addClass('active');
			code = _that.find('.list-code label').text();
			$('#unit').val(code);
			_that.append('<i class="fa fa-check"></i>');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var colorbox =  __webpack_require__(14);
...
/***/ function(module, exports) {
	...
	$('.navbar-toggle').click(function(event) {
	            event.preventDefault()
	            if ($('.pri-nav').hasClass('in')) {
	                $(this).removeClass('active').trigger('blur');
	                $('.pri-nav').removeClass('in');
	            } else {
...
/***/ function(module, exports) {
	 ...
	 $('#video').css({ width: $(window).innerWidth() + 'px', height: $(window).innerHeight() + 'px' });
	    setTimeout(function(){
	    	//$('.crt-parallaxvideo').css({'z-index':'1'});
	    	$('#video').css({'opacity':'1'});
	    },3000);
