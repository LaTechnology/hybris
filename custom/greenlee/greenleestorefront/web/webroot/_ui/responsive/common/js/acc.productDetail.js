...
$(document).ready(function ()
		{
			...
			$(".sendProductAsEmailButton").click(shareProduct);
...
function shareProduct() {
	...
	$.ajax({
		url : location.href+'/send-to-friend',
		type : 'POST',
		data : {'toAddress':json['toAddress'],'fromAddress':json['fromAddress'],'message':json['message']},
		dataType:'json',
