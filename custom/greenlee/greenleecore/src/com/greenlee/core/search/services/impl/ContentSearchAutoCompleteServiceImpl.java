 ...
 * 
 */
public class ContentSearchAutoCompleteServiceImpl implements ContentSearchAutoCompleteService

{
	private static final Logger LOG = Logger.getLogger(ContentSearchAutoCompleteServiceImpl.class);
	...
	@Override
	public List getAutoCompleteSuggestions(final String input)
	{
		try
		{
