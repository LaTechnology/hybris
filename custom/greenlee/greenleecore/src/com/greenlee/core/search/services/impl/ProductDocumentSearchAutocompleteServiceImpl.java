 ...
 * 
 */
public class ProductDocumentSearchAutocompleteServiceImpl implements
		ProductDocumentSearchAutocompleteService<AutocompleteSuggestion>
{

	private static final Logger LOG = Logger.getLogger(ProductDocumentSearchAutocompleteServiceImpl.class);
	...
	public List<AutocompleteSuggestion> getAutocompleteSuggestions(final String input)
	{
		try
		{
			final SolrFacetSearchConfigModel solrFacetSearchConfigModel = getSolrFacetSearchProductDocumentConfigSelectionStrategy()
		...
		{
			LOG.warn(GreenleeCoreConstants.ERROR_MSG, e);
		}
