 ...
 * 
 */
public class DocumentMimeValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
			...
			final Object object) throws FieldValueProviderException
	{
		...
		if (object instanceof GreenleeProductMediaModel)
		{
			...
			{
				fieldValues.add(new FieldValue(fieldName, productDocument.getMime()));
			}
		}
