 ...
 *  
 */
package com.greenlee.sapintegration.jalo;
...
import com.greenlee.sapintegration.constants.GreenleesapintegrationConstants;



/**
 * This is the extension manager of the Greenleesapintegration extension.
 */
public class GreenleesapintegrationManager extends GeneratedGreenleesapintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GreenleesapintegrationManager.class.getName());
	 ...
	 */
	public static GreenleesapintegrationManager getInstance()
	{
		return (GreenleesapintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GreenleesapintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GreenleesapintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GreenleesapintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GreenleesapintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GreenleesapintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
