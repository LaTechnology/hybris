...
/**
 * This is the extension manager of the Greenleesalsify extension.
 */
public class GreenleesalsifyManager extends GeneratedGreenleesalsifyManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GreenleesalsifyManager.class.getName());
	 ...
	 */
	public static GreenleesalsifyManager getInstance()
	{
		return (GreenleesalsifyManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GreenleesalsifyConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GreenleesalsifyManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GreenleesalsifyManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GreenleesalsifyManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GreenleesalsifyManager called, current tenant: " + getTenant().getTenantID());
		}
	}
